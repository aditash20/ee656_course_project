...
import os
import numpy as np
from tqdm import tqdm # A great library for progress bars! pip install tqdm
...
def extract_all_features(preprocessed_signal):
    ...
    """
    # This combines all your feature extraction modules into one call
    ...
    # Combine into one final vector of 286 features
...
def process_all_data():
    ...
    # 1. Define the class labels
    # It's important to have a consistent order for the labels
    ...
    # 2. Iterate through each class folder
    for folder_name, label in label_map.items():
        ...
        for filename in tqdm(files_in_folder, desc=f"Folder {folder_name}"):
            ...
            try:
                # a. Load the signal from the .dat file
                # Assuming the data is 32-bit float. Adjust if necessary.
    ...
    # 4. Save the final arrays to disk
...
if __name__ == '__main__':
    # Make sure your project structure is set up correctly before running
    # Project_Root/
    #  ├── AirCompressor_Data/
    #  │   ├── Bearing/
    #  │   └── ...
